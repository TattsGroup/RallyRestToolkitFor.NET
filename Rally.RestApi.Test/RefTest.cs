...
namespace Rally.RestApi.Test
{
	...
	public class RefTest
	{
		...
		public void ShouldDetectValidRefs()
		{
			...
			Assert.IsTrue(Ref.IsRef("https://rally1.rallydev.com/slm/webservice/v2.0/defect/1234"), "Valid absolute ref");
			Assert.IsTrue(Ref.IsRef("http://rally1.rallydev.com/slm/webservice/v2.0/defect/1234.js"), "Valid absolute ref w/ extension");
		...
		public void ShouldDetectValidDynatypeRefs()
		{
			...
			Assert.IsTrue(Ref.IsRef("https://rally1.rallydev.com/slm/webservice/v2.0/portfolioitem/feature/1234"), "Valid absolute ref");
			Assert.IsTrue(Ref.IsRef("http://rally1.rallydev.com/slm/webservice/v2.0/portfolioitem/feature/1234.js"), "Valid absolute ref w/ extension");
		}
		...
		public void ShouldDetectInvalidRefs()
		{
			...
			Assert.IsFalse(Ref.IsRef("https://rally1.rallydev.com/slm/webservice/v2.0/defect/abc.js"), "Invalid ref");
		...
		public void ShouldReturnValidRelativeRefs()
		{
			...
			Assert.AreEqual(Ref.GetRelativeRef("https://rally1.rallydev.com/slm/webservice/v2.0/defect/1234"), "/defect/1234", "Absolute ref");
		}
		...
		public void ShouldReturnValidDynatypeRelativeRefs()
		{
			...
			Assert.AreEqual(Ref.GetRelativeRef("https://rally1.rallydev.com/slm/webservice/v2.0/portfolioitem/feature/1234"), "/portfolioitem/feature/1234", "Absolute ref");
		}
		...
		public void ShouldReturnTypesFromRefs()
		{
			...
			Assert.AreEqual(Ref.GetTypeFromRef("https://rally1.rallydev.com/slm/webservice/v2.0/defect/1234"), "defect", "Valid absolute ref");
		}
		...
		public void ShouldReturnTypesFromDynatypeRefs()
		{
			...
			Assert.AreEqual(Ref.GetTypeFromRef("https://rally1.rallydev.com/slm/webservice/v2.0/portfolioitem/feature/1234"), "portfolioitem/feature", "Valid absolute ref");
		}
		...
		public void ShouldReturnOidsFromRefs()
		{
			...
			Assert.AreEqual(Ref.GetOidFromRef("https://rally1.rallydev.com/slm/webservice/v2.0/defect/1234"), "1234", "Valid absolute ref");
		}
		...
		public void ShouldReturnOidsFromDynatypeRefs()
		{
			...
			Assert.AreEqual(Ref.GetOidFromRef("https://rally1.rallydev.com/slm/webservice/v2.0/portfolioitem/feature/1234"), "1234", "Valid absolute ref");
		}
		...
		{
			Assert.AreEqual(Ref.GetRelativeRef("https://rally1.rallydev.com/slm/webservice/v2.0/workspacepermission/123u456w1"), "/workspacepermission/123u456w1", "Valid workspace permission ref");
		...
		public void ShouldSupportProjectPermissionRefs()
		{
			...
			Assert.AreEqual(Ref.GetRelativeRef("https://rally1.rallydev.com/slm/webservice/v2.0/projectpermission/123u456p1"), "/projectpermission/123u456p1", "Valid project permission ref");
		...
		{
			Assert.AreEqual(Ref.GetRelativeRef("https://rally1.rallydev.com/slm/webservice/v2.0/defect/1234/tasks"), "/defect/1234/tasks", "Valid collection ref");
			Assert.AreEqual(Ref.GetRelativeRef("/defect/1234/tasks"), "/defect/1234/tasks", "Valid relative collection ref");
			Assert.AreEqual(Ref.GetRelativeRef("https://rally1.rallydev.com/slm/webservice/v2.0/portfolioitem/feature/1234/children"), "/portfolioitem/feature/1234/children", "Valid dynatype collection ref");
